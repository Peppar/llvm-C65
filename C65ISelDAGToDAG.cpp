...
public:
  ...
  bool SelectADDRi(SDValue N, SDValue &Offset);
  bool SelectADDRix(SDValue N, SDValue &Base, SDValue &Offset);
...
bool C65DAGToDAGISel::SelectADDRri(SDValue Addr,
...
bool C65DAGToDAGISel::SelectADDRrr(SDValue Addr, SDValue &R1, SDValue &R2) {
...
/// C65-specific DAG, ready for instruction scheduling.
///
