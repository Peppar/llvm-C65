...
public:
  ...
  createObjectTargetWriter() const override {
    return createC65WLAKObjectTargetWriter(OSABI);
  }
};
...
void C65MCAsmBackend::applyFixup(const MCAssembler &Asm,
                                 const MCFixup &Fixup,
...
bool C65MCAsmBackend::writeNopData(raw_ostream &OS, uint64_t Count) const {
